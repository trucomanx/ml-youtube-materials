...
\title{Statistical Comparison of Model Performance using k-Fold Cross-Validation and Wilcoxon Test}
...
{\includegraphics[width=2.5cm]{images/homepage.pdf}};
\end{tikzpicture}
}
...
\begin{figure}
 \centering
 \includegraphics[width=0.65\linewidth]{images/dilema.pdf}
\end{figure}
\end{frame}
...
\begin{figure}
 \centering
 \includegraphics[width=0.95\linewidth]{images/kfold0.pdf}
\end{figure}
...
\begin{figure}
 \centering
 \includegraphics[width=0.95\linewidth]{images/kfold.pdf}
\end{figure}
...
\begin{center}
\Large
Does A really perform better than B?
\end{center}
...
\begin{center}
\Large
\textbf{Now we have a principled way to answer that.}
\end{center}
